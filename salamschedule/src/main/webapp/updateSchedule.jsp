...
<body>
	...
	<a href="ListScheduleController"><button >Back</button></a><br><br>
		...
		<div class="card">
			<div class="card-body">
			<form method="post" action="UpdateScheduleController">
					<caption>
					...
					<fieldset class="form-group">
						...
						<input type="date" class="form-control" id="scheduledate" name="scheduledate" required="required" placeholder="01-01-2022" value="${s.scheduledate}"/>
					</fieldset>
					...
					<fieldset class="form-group">
						<label>Imam ID</label> 
						<input type="text" class="form-control" id="imamid" name="imamid" placeholder="Imam01" value="${s.imamid}">
					</fieldset>
	
					<fieldset class="form-group">
						<label>Bilal ID</label> 
						<input type="text" class="form-control" id="bilalid" name="bilalid" placeholder="Bilal01" value="${s.bilalid}">
					</fieldset>
					
					<input type="hidden" name="staffid" value="${s.scheduleid}"/>
